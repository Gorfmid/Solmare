...
**Status:** Acts I–IV **LOCKED FINAL** · Ch. 1–24 + Epilogue complete (Epilogue **2026-07-14**) · **END BOOK ONE**. See `Act_Outlines/chapter_list.md` · `Notes/REWRITE_STATUS.md`.
...
**Cultural identity:** `Writing_System/Series_Principles/cultural_identity_and_philosophical_foundation.md`

---

## Book Overview

For centuries, the Fleet Authority has maintained peace throughout the Solmare Quadrant through diplomacy, commerce, exploration, and overwhelming military strength.

Its citizens believe the future is secure.
...
**Act I ends:** Mission underway; peace assumed; Incident not yet begun.

### Act II — The Kestrel Veil Incident (Ch. 5–8) ✓ LOCKED

The book's **core defining event**.

5. **Mission's End** — Structured contact; passive lock; *Veil* believed destroyed
6. **First Contact** — Dual POV survival; watchpost void; crippled scout
7. **The Living Ship** — Incomplete recovery; Fleet correction; seven-alpha orders
8. **The Quiet Before the Silence** — VI-Gamma stopover; departure; alone on approach

**Act II ends:** Post-incident stabilization complete; *Veil* re-entering contact volume.

### Act III — Shadows Beyond the Border (Ch. 9–16)

**Discovery of the Dominion** as a living superpower — not a faceless enemy. See `Universe/The_Dominion/dominion_worldview.md` (series foundation) and `Act_Outlines/act3_dominion_worldbuilding.md` (Act III scenes).
...
**Act IV ends:** Fleet permanently changed; Book One complete.

---

## Canonical Framing (Replaces Prior Interpretation)

| Remove / replace | Canonical |
|------------------|-----------|
| Isolated episodic incidents | Escalation of understanding across four acts |
| Mystery-driven anomaly logs as central hook | Structured opposing presence beyond the border |
| Enemy as **expanding structured civilization** | Neither side cartoon villain; philosophical security conflict; **true antagonist is history** (`cultural_identity_and_philosophical_foundation.md` · `dominion_worldview.md`) |
| Ch. 5 as Act I cliff only | Ch. 5–8 as complete **Incident arc** (Act II) |
| Fold / living map / reality-fracture Act III–IV | Border intelligence → doctrine formation |
...
Calder begins as procedural optimist — graduation hope, aging ship, routine mission.
...
| Document | Role |
|----------|------|
| `Writing_System/Style_Guide/solmare_craft_doctrine.md` | POV flow, competence, dialogue, scene test |
| `Act_Outlines/chapter_list.md` | Chapter roadmap (4-act) |
| `Act_Outlines/act2_chapters_5-8_generation.md` | Incident arc |
| `Universe/The_Dominion/dominion_worldview.md` | Dominion series foundation — strategic philosophy, doctrine, society |
| `Act_Outlines/act3_dominion_worldbuilding.md` | Act III Dominion scene rules |
| `Act_Outlines/act3_chapters_9-16_generation.md` | Border intelligence arc |
| `Act_Outlines/act4_chapters_17-24_generation.md` | Doctrine arc |
| `State/current_state.md` | Runtime state (post–Ch. 8) |
| `Notes/mystery_spine.md` | Operational uncertainty spine |

---

## Legacy Draft Note

Prior Ch. 9–24 draft (anomaly-first, KR-13, living map, Fold arc) is **superseded**. Do not restore without outline revision. Ch. 1–8 Incident prose is **locked canon**.

**Written status:** Ch. **1–8 LOCKED** (~49,150 words). Ch. 9–24 shells pending rewrite against 4-act architecture.
