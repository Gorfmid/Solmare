...
Before Lin had taken the chair, Holt had cleared the turnover packet from the previous watch—four pages, every line *no variance* or *within tolerance*. She had signed receipt and filed it without reading past the summary block. Reading the whole thing was for audits. Audits were not this shift.
...
"Eleven clear," Lin said. Holt signed without comment.
...
Pattern fatigue was in Holt's eyes, not in the log. Lin had it too—the flat focus of a long shift where silence counted as performance. They did not comment on it. Commenting was not in the checklist.

Lin ran the scheduled sweep, then offset without waiting for Holt to prompt the second pass. Holt signed both when Lin pushed the strip summary across.
...
Operations sent a sector scan template reminder—quarterly form, due in six weeks. Holt acknowledged. Lin did not look up. Acknowledging forms was not sensor work.
...
Holt stood behind the chair. She did not take the chair. Lin hated being moved mid-pass.

"Transient artifact," Lin said. "Could be local drift."
...
Lin marked contact alpha. Holt signed the block.
...
Holt made tea she did not drink. Lin skipped food because skipping food was her habit on long correlation blocks; Holt told her to eat anyway every shift and Lin ate anyway every shift, minimally, without breaking eye contact with the board.
...
Lin read strip timestamps aloud. Holt let the numbers finish.
...
She closed it before Lin could see her face. The name sat where a contact bearing should have stayed anonymous.
...
Lin was still speaking—residual scatter, band six decay, timestamps—but Dana heard her own heartbeat louder. The overlay line she had closed six minutes ago returned without permission: **Kestrel Veil.** Jun Park. Fourteen names on a complement she was not supposed to look up on watch. Calder she did not know. Brenner she had met once at a yard bar. Fourteen people who ate standing up and sent messages you meant to answer tomorrow.
...
Lin, without looking up from the annex: "Chief. Timestamp on the discharge block."
...
Lin finished the technical annex.
