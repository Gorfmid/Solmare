...
**Schematic:** `kestrel_veil_schematic.png` (reader placement: Appendix G)  
...
The **Kestrel Veil** is an aging Fleet reconnaissance scout—forty-plus years in service, continually repaired, never fully restored.
...
The *Kestrel* is one of Book One's principal characters.
...
She carries Fleet's only witness through the Incident (Act II) and Dominion-monitored space (Act III). She returns to Fleet space damaged, functional, and data-heavy (Act III close).

**Do not:** make her magical, sentient in exposition, or indestructible. **Do:** show competence under degradation.
...
- Command chair squeak noted by Tanaka.
...
### End of Book One Act III

- Crossed into Dominion-monitored space and **returned to Fleet space**.
- Remains **damaged but functional**.
- Local buffers hold segment seven observations (Park triple redundancy).
...
**Crew learns moods through work, not superstition.** No oracle machine. No haunted ship beat.
...
### Supporting witness texture
- **Reyes** — navigation, lane age, home vectors
- **Ortega** — listen watch, traffic rhythm
- **Tanaka** — emitters dark, emitter confirmation
- **Yuki Tanaka / Marcus Hale** — rotation, discipline

---

## 6. Recurring Ship Language

Canon phrases (use sparingly; earned repetition):

| Phrase | Typical speaker | Meaning |
|--------|-----------------|---------|
...
Small, grounded, supported by text— **invent no grand rituals.**

| Tradition | Origin | Tone |
|-----------|--------|------|
| **Corridor C kick** | Brenner; door frame tolerance | Practical, passed to new captains by observation |
| **Hand marks at power junctions** | Decades of crew transit | Muscle memory; no briefing explains it |
| **Yellow tape on dents** | Documented, ignored, stepped around | Institutional shrug |
| **Engineering religion jokes** | Koss/Brenner coupler vs. duct tape | Dry, professional |
...
| **Strategic cargo** | *Structured Civilization Beyond Fleet Survey Assumptions* — report that will reshape doctrine |

**First contact:** technically not occurred (Calder/Thessaly position).

---

## 9. Future Use

The *Kestrel* should remain **emotionally central** through Act IV and beyond.

| Do | Don't |
|----|-------|
| Show her through crew behavior, sound, vibration, procedure | Make her magically aware or self-healing |
| Let Brenner/Koss disagree with instruments | Over-explain propulsion or sensor specs in exposition |
| Use ship language sparingly | Turn every scene into ship-personification |
| Keep *patched, not repaired* honest | Reset damage between books without account |
| Let Calder's relationship mature with command burden | Replace her with a shiny new hull for convenience |

**Series note:** She is Fleet's witness hull. Losing her casually would cost the saga a principal character.
...
*Ship bible v1.0 — post Act III (Ch. 16)*
